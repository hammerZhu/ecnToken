...
contract VestingTrustee is Ownable {
    ...
    /// @dev Constructor that initializes the address of the Ecn token contract.
    /// @param _ecn EcnToken The address of the previously deployed Ecn token contract.
    function VestingTrustee(EcnToken _ecn) {
        require(_ecn != address(0));
    ...
    function grant(address _to, uint256 _value, uint256 _start, uint256 _cliff, uint256 _end,
        ...
        require(totalVesting.add(_value) <= ecn.balanceOf(address(this)));
    ...
    function revoke(address _holder) public onlyOwner {
        ...
        //ecn.transfer(msg.sender, refund);
    ...
    function unlockVestedTokens() external {
        ...
        ecn.transfer(msg.sender, transferable);
